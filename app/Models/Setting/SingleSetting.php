	...
	public static function getFields($diskName)
	{
		$fields = [
			...
			[
				...
				'hint'              => 'publication_form_type_hint',
				'wrapperAttributes' => [
			...
			[
				...
				'label'             => 'picture_mandatory_label',
				'type'              => 'checkbox',
				'hint'              => 'picture_mandatory_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
			...
			[
				'name'              => 'pictures_limit',
				'label'             => 'Pictures Limit',
				'type'              => 'number',
				'hint'              => 'pictures_limit_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
				],
			],
			...
			[
				...
				'type'  => 'custom_html',
				'value' => 'around_phone_number_sep',
			],
			[
				'name'              => 'show_security_tips',
				'label'             => 'show_security_tips_label',
				'type'              => 'checkbox',
				'hint'              => 'show_security_tips_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
					'style' => 'margin-top: 10px;',
				],
			...
			[
				...
				'label'             => 'enable_whatsapp_btn_label',
				'type'              => 'checkbox',
				'hint'              => 'enable_whatsapp_btn_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
					'style' => 'margin-top: 10px;',
				],
			...
			[
				...
				'label'             => 'pre_filled_whatsapp_message_label',
				'type'              => 'checkbox',
				'hint'              => 'pre_filled_whatsapp_message_hint',
				'wrapperAttributes' => [
					'class' => 'form-group col-md-6',
					'style' => 'margin-top: 10px;',
				],
